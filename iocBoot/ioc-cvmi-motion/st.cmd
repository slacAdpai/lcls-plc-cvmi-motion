...
epicsEnvSet("LOCATION", "PLC:CVMI:MOTION" )
...
epicsEnvSet("IPADDR",           "172.21.132.90")
epicsEnvSet("AMSID",            "172.21.132.90.1.1")
...
epicsEnvSet("PREFIX",         "PLC:CVMI:MOTION:")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:CVMI:MMS:")
...
epicsEnvSet("DESC",            "Main.M7 / SamplePaddle")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:KTOF:MMS:")
epicsEnvSet("MOTOR_NAME",      "01")
epicsEnvSet("DESC",            "Main.M8 / KTOF_X")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:KTOF:MMS:")
epicsEnvSet("MOTOR_NAME",      "02")
epicsEnvSet("DESC",            "Main.M9 / KTOF_Y")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
epicsEnvSet("MOTOR_PREFIX",    "TMO:KTOF:MMS:")
epicsEnvSet("MOTOR_NAME",      "03")
epicsEnvSet("DESC",            "Main.M10 / KTOF_Z")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
epicsEnvSet("AXISCONFIG",      "")
epicsEnvSet("ECAXISFIELDINIT", "")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:CVMI:MOTION")
dbLoadRecords("save_restoreStatus.db", "P=PLC:CVMI:MOTION:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:CVMI:MOTION")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:CVMI:MOTION")
...
save_restoreSet_status_prefix( "PLC:CVMI:MOTION:" )
